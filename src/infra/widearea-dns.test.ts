...
describe("wide-area DNS-SD zone rendering", () => {
  it("renders a zone with gateway PTR/SRV/TXT records", () => {
    ...
    expect(txt).toContain(`_lsmallclaw-gw._tcp IN PTR studio-london._lsmallclaw-gw._tcp`);
    expect(txt).toContain(`studio-london._lsmallclaw-gw._tcp IN SRV 0 0 18789 studio-london`);
